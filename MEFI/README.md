...
- MEFI.ipynb : (Only use in case of top 3 files having errors which need deeper level investigation) ->  This notebook processes BRFSS data from various years, standardizing and mapping it to current CBSA codes, and then enriches this information with MEFI scores and population figures. This complex mapping process ensures accurate linking of older BRFSS data to current metropolitan area classifications and MEFI scores, particularly for years 2007, 2008, and 2012.
- 
